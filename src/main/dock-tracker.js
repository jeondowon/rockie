...
//   - 단, 자동화(Automation)와 손쉬운 사용(Accessibility)이 **둘 다** 필요하다.
//     한 줄이지만 두 단계다. Rockie가 System Events에게 말을 거는 것이 자동화이고,
//     System Events가 Dock의 UI 요소(list 1)를 읽는 것이 손쉬운 사용이다. macOS는
//     후자를 심부름꾼(System Events)이 아니라 **처음 시킨 앱(Rockie)** 기준으로 본다.
