...
const MAIN_QUESTIONS = [
  {
    ...
    options: [
      ...
      },
      {
        stone: "marble",
        traitTag: "메시지 중심형",
        label: "듣는 사람에게 어떤 인상을 줄지 먼저 생각한다",
      },
      {
        stone: "gneiss",
        traitTag: "전략 설계형",
    ...
    options: [
      {
        stone: "granite",
        traitTag: "실질 지원형",
        label: "필요하면 같이 해결 방법을 정리해주겠다고 말한다",
      },
      {
        stone: "basalt",
        traitTag: "활력 전환형",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        stone: "basalt",
        traitTag: "핵심 체감형",
        label: "일단 말해보면서 반응 좋은 내용을 고르자",
      },
      {
        stone: "marble",
        traitTag: "청중 공감형",
        label: "듣는 사람이 이해하기 쉬운 흐름을 고르자",
      },
      {
        stone: "gneiss",
        traitTag: "논증 구조형",
...
const TIEBREAKERS = [
  ...
  },
  {
    ...
    category: "타이브레이커",
    situation:
      "중요한 일을 앞두고 계획과 마음의 편안함이 서로 부딪히고 있어요.",
    text: "나는 무엇을 먼저 챙길까요?",
    options: [
  ...
  },
  {
    ...
    category: "타이브레이커",
    situation:
      "감정이 크게 움직이는 순간이에요. 바로 표현할 수도, 안쪽에서 살필 수도 있습니다.",
    text: "나는 어느 쪽에 더 가까울까요?",
    options: [
  ...
  },
  {
    ...
    category: "타이브레이커",
    situation:
      "새로운 도전이 눈앞에 있어요. 해보며 배울 수도, 원리를 먼저 볼 수도 있습니다.",
    text: "나는 어떻게 시작할까요?",
    options: [
  ...
  },
  {
    ...
    category: "타이브레이커",
    situation:
      "어려운 문제에 사람들의 마음과 논리적인 판단이 함께 얽혀 있어요.",
